...
class ElectonicaView extends StatelessWidget {
  final List<Map<String, String>> productos = [
    {
      ...
      'precio': '25.00',
      'imagen':
          'https://yazbek.com.mx/cdn/shop/products/C0306-playera-cv-mc-caballero-100algodon-blanco_2.jpg?v=1693280739'
    },
    {
      'nombre': 'Jeans Azul',
      'precio': '40.00',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Productos electronicoos'),
      ),
      body: Padding(
...
class ElectonicaView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Productos Electrónicos'), // Corrige el título
      ),
      body: Padding(
        padding: const EdgeInsets.all(8.0),
        child: GridView.builder(
...
class _ElectronicaViewState extends State<ElectronicaView> {
  ...
  Future<void> _fetchProducts() async {
    try {
      final productosElectronica = await ProductService().getProductsByCategory(
          4); // Asegúrate de usar el ID correcto para "Electrónica"
      setState(() {
